"""表达逻辑 (Logic Clarity) — PKBench v5 single-dim plugin.
...
META = {
    ...
    "level": "transcript",
    "group": "Pikaia-Bench",
    "homepage": "https://github.com/Pikaia-AI/rubric/tree/main/rubric/builtin_metrics/pkbench_logic_clarity",
