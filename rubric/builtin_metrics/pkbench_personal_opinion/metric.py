"""个人观点表达 (Personal Opinion) — PKBench v5 single-dim plugin.
...
META = {
    ...
    "group": "Pikaia-Bench",
    "homepage": "https://github.com/Pikaia-AI/rubric/tree/main/rubric/builtin_metrics/pkbench_personal_opinion",
