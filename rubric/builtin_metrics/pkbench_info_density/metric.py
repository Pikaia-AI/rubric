"""有效信息密度 (Info Density) — PKBench v5 single-dim plugin.
...
META = {
    ...
    "group": "Pikaia-Bench",
    "homepage": "https://github.com/Pikaia-AI/rubric/tree/main/rubric/builtin_metrics/pkbench_info_density",
