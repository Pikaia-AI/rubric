"""回答扩展 (Answer Expansion) — PKBench v5 single-dim plugin.
...
META = {
    ...
    "group": "Pikaia-Bench",
    "homepage": "https://github.com/Pikaia-AI/rubric/tree/main/rubric/builtin_metrics/pkbench_answer_expansion",
