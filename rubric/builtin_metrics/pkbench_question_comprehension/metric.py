"""准确理解问题 (Question Comprehension) — PKBench v5 single-dim plugin.
...
DIM_KEY = "question_comprehension"
...
META = {
    ...
    "level": "transcript",
    "group": "Pikaia-Bench",
    "homepage": "https://github.com/Pikaia-AI/rubric/tree/main/rubric/builtin_metrics/pkbench_question_comprehension",
