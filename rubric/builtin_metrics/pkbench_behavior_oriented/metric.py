"""行为导向 (Behavior-Oriented) — PKBench v5 single-dim plugin.
...
META = {
    ...
    "level": "transcript",
    "group": "Pikaia-Bench",
    "homepage": "https://github.com/Pikaia-AI/rubric/tree/main/rubric/builtin_metrics/pkbench_behavior_oriented",
