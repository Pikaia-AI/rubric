"""问题表达清晰 (Question Clarity) — PKBench v5 single-dim plugin.
...
META = {
    ...
    "level": "transcript",
    "group": "Pikaia-Bench",
    "homepage": "https://github.com/Pikaia-AI/rubric/tree/main/rubric/builtin_metrics/pkbench_question_clarity",
